...
namespace CFSISBusiness
{
    ...
    /// in a single graph.
    /// </summary>
    public  class CFSISDataImporter
    {
                public static bool EnsureAlbumData(CFSISContext context, string jsonDataFilePath)
        {
            bool hasData = false;
            try
            {
        ...
        /// <returns></returns>
        public static int ImportFromJson(CFSISContext context, string json)
        {
